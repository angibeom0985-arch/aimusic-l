...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary:
      "bg-gradient-to-r from-pink-500 to-orange-400 text-white hover:from-pink-600 hover:to-orange-500 focus:ring-pink-500",
    secondary:
      "bg-zinc-800 hover:bg-zinc-700 text-zinc-100 focus:ring-zinc-600",
    ghost:
      "bg-transparent hover:bg-zinc-800 text-zinc-300 focus:ring-zinc-700 border border-zinc-800",
    success:
