        ...
        {genres.map((genre, index) => {
          ...
          return (
            <button
              ...
              className={`p-4 bg-gradient-to-r ${colors[index % colors.length]} rounded-lg text-center font-medium hover:scale-105 transform transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-zinc-900 shadow-md hover:shadow-lg`}
            >
              {genre}
            </button>
          );
