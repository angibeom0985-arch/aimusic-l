  ...
  return (
    <div className="bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 border border-zinc-700/50 rounded-xl shadow-2xl p-8 max-w-4xl mx-auto">
      ...
      <p className="text-zinc-400 mb-6">
        AI 음원 가사 및 썸네일 제작을 사용하기 위해 필요한 Google Gemini API 키를 발급받는 방법을 단계별로 안내드립니다.
      </p>
      ...
      <div className="space-y-8 text-zinc-300">
        ...
        <section className="bg-zinc-800/50 rounded-lg p-6 shadow-lg">
          ...
          />
          <p className="mb-3">
            위 스크린샷과 같이 왼쪽 사이드바에서 <strong className="text-pink-300">"Get API key"</strong> 버튼을 클릭하여 API 키 생성 페이지로 이동합니다.
          </p>
          <div className="bg-zinc-900/50 rounded-lg p-4 mt-4">
            <p className="mb-2"><strong>순서:</strong></p>
            <p className="mb-2">✅ No Cloud Projects Available 클릭하면, 아래 'Create project'가 나옵니다.</p>
            <p className="text-yellow-400">⚠️ Import project: Google Cloud 프로젝트가 있는 경우에만 선택</p>
          </div>
        </section>
        ...
        <section className="bg-zinc-800/50 rounded-lg p-6 shadow-lg">
          ...
          <div className="bg-zinc-900/50 rounded-lg p-4">
            <p className="mb-2"><strong>API 키 형태 예시:</strong></p>
        ...
        <section className="bg-zinc-800/50 rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-pink-400 flex items-center gap-2">
            <span className="text-3xl">6️⃣</span> AI 음원 제작 사이트에 API 키 입력
          </h2>
          <img
            src="/api 6.png"
            alt="웹사이트에 API 키 입력"
          ...
          />
          <p className="mb-4">
            API 키가 성공적으로 생성되었습니다! 생성된 API 키를 복사하여 안전한 곳에 보관합니다.
          </p>
          <p className="mb-4">
            이제 AI 음원 가사 및 썸네일 제작 웹사이트로 돌아가서 발급받은 API 키를 입력합니다.
          </p>
          <div className="bg-zinc-900/50 rounded-lg p-4">
        ...
        <section className="bg-zinc-800/50 rounded-lg p-6 shadow-lg">
          ...
          <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/40 rounded-lg p-6 text-center">
            <p className="text-2xl font-bold text-green-300 mb-4">🎉 축하합니다!</p>
            <p className="text-lg mb-4">API 키 설정이 모두 완료되었습니다.</p>
            <p className="mb-4">이제 AI 음원 가사 및 썸네일 제작의 모든 기능을 사용할 수 있습니다.</p>
          </div>
        ...
        <section className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-lg p-6 shadow-lg">
          ...
          <div className="space-y-4">
            <div className="bg-zinc-900/50 rounded-lg p-4">
              <h3 className="font-semibold text-lg text-purple-300 mb-2">Q: API 키가 작동하지 않아요</h3>
              <p className="text-zinc-300">
                A: API 키를 정확히 복사했는지 확인하고, 앞뒤 공백이 없는지 체크해주세요. Google AI Studio에서 해당 프로젝트가 활성화되어 있는지 확인하세요.
              </p>
            </div>
            <div className="bg-zinc-900/50 rounded-lg p-4">
              <h3 className="font-semibold text-lg text-purple-300 mb-2">Q: 무료로 얼마나 사용할 수 있나요?</h3>
              <p className="text-zinc-300">
                A: Google Gemini API는 월 일정량까지 무료로 제공됩니다. 정확한 한도는 Google AI Studio에서 확인할 수 있습니다.
              </p>
            </div>
            <div className="bg-zinc-900/50 rounded-lg p-4">
              <h3 className="font-semibold text-lg text-purple-300 mb-2">Q: API 키를 잃어버렸어요</h3>
              <p className="text-zinc-300">
                A: Google AI Studio에서 새로운 API 키를 생성하거나, 기존 키를 다시 확인할 수 있습니다. 보안을 위해 이전 키는 비활성화하는 것이 좋습니다.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-zinc-800/50 rounded-lg p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <p className="font-semibold text-blue-300 mb-1">🔄 Gemini API 속도 제한</p>
              <p className="text-sm text-zinc-400">무료 등급에서 사용 가능한 API 요청 제한</p>
            </a>
            <a
            ...
            >
              <p className="font-semibold text-green-300 mb-1">💰 Gemini API 요금 안내</p>
              <p className="text-sm text-zinc-400">API 사용 요금 및 무료/유료 등급 정보</p>
            </a>
          </div>
        </section>
      </div>
